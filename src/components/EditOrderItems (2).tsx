...
export default function EditOrderItems({ order, onCancel, onSaved }: Props) {
  ...
  const [fulfillmentType, setFulfillmentType] = useState(order.fulfillment_type);
  const [fulfillmentDate, setFulfillmentDate] = useState(order.fulfillment_date);
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <section className="flex flex-col gap-3">
        <h3 className="font-display font-600 text-base text-maroon-800">Fulfillment</h3>
